                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      ...
                      padding: "8px 12px",
                      backgroundColor:
                        item.status === "isReviewed" ? "#f0f0f0" : "#FFE7E1", // change background color when disabled
                      borderRadius: "8px",
                      cursor: "pointer", // change cursor when disabled
                      transition: "background-color 0.3s",
                      pointerEvents:
                        item.status === "isReviewed" ? "none" : "auto", // disable pointer events when reviewed
                      opacity: item.status === "isReviewed" ? 0.8 : 1, // optional: reduce opacity when disabled
                    }}
                  >
                    <span
                      style={{
