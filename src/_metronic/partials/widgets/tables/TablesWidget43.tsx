...
import { AddDesignationSchool } from "../../modals/create-app-stepper/AddDesignationSchool";
...
const TablesWidget43: React.FC<TablesWidget43Props> = ({ schoolId }) => {
  ...
  const handleModules = (designationId: number) => {
    Navigate(
      `/manage/designation-modules?schoolId=${schoolId}&designationId=${designationId}`
    );
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <AddDesignationSchool
          show={showModal}
          handleClose={handleCloseAddModal}
          setRefresh={setRefresh}
          assignedDesignationIds={designations.map(
