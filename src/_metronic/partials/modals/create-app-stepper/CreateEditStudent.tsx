...
const CreateEditStudent = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.student_name || !formData.roll_no) {
      alert("Please fill in all required fields: Student Name, Admission No, Roll No, First Name, and Last Name.");
      return;
    }
    ...
    try {
      const response = await fetch(`${DOMAIN}/api/school/edit-student/${school_id}/${studentId}`, {
        method: "PUT",
        headers: {
      ...
      <div className="modal-body " style={{ backgroundColor: "#F2F6FF" }}>
        <Form onSubmit={handleSubmit} style={{ width: "100%", height: "100%" }}>
          ...
          <Row className="mb-4">
            ...
            <Col md={6}>
              <Form.Group controlId="student_roll_no">
