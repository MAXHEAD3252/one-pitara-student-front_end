...
const ToolbarFeeMaster = ({ onSelectValue } : any) => {
  const [selectedRange, setSelectedRange] = useState([]);

  // console.log(selectedRange);
  
  const [selectedTab, setSelectedTab] = useState('current_year');
   ...
   className={`btn me-1 d-flex justify-content-center align-items-center ${
    selectedTab === '3M' ? 'active' : ''}`}
                    ...
                    style={{
                      width: "40px",
                      height: "36px",
                      color: selectedTab === '3M' ? '#FFFFFF' : '#252525',
                      backgroundColor: selectedTab === '3M' ? '#1F3259' : '#F3F3F3',
                      borderRadius: "8px",
                      padding: "8px 10px 8px 10px",
                      gap: "10px",
                      fontSize: "12px",
                ...
                <li className="nav-item rounded">
                  <a
                    ...
                    style={{
                      width: "40px",
                      height: "36px",
                      color: selectedTab === '6M' ? '#FFFFFF' : '#252525',
                      backgroundColor: selectedTab === '6M' ? '#1F3259' : '#F3F3F3',
                      borderRadius: "8px",
                      padding: "8px 10px 8px 10px",
                      gap: "10px",
                      fontSize: "12px",
                ...
                <li className="nav-item rounded">
                  <a
                    className={`btn me-1 d-flex justify-content-center align-items-center ${
                      selectedTab === 'current_year' ? 'active' : ''
                    }`}
                    data-bs-toggle="tab"
                    href="#"
                    onClick={() => handleClick("current_year")}
                    style={{
                      width: "105px",
                      height: "36px",
                      color: selectedTab === 'current_year' ? '#FFFFFF' : '#252525',
                      backgroundColor: selectedTab === 'current_year' ? '#1F3259' : '#F3F3F3',
                      borderRadius: "8px",
                      padding: "8px 10px 8px 10px",
                      gap: "10px",
                      fontSize: "12px",
          ...
          <div
            ...
            style={{
              width: "216px",
              height: "36px",
              color: selectedTab === 'date' ? '#FFFFFF' : '#252525',
              backgroundColor: selectedTab === 'date' ? '#1F3259' : '#F3F3F3',
              padding: "8px 10px 8px 10px",
              borderRadius: "8px",
              fontWeight: "500",
              fontSize: "12px",
