...
const get_users_count = "api/superadmin/users-count";
const get_subscription_count = "api/superadmin/subscription-count";
...
const getDesignationById = "api/superadmin/get-designation";
