  ...
  return (
    ...
    >
       ...
       <div className='text-center mb-11'>
         <h1 className='text-gray-900 fw-bolder mb-3'>Sign In Staff</h1>
      ...
      {formik.status ? (
        ...
        <div className='mb-10 bg-light-info p-8 rounded'>
          <div className='text-info'>
            Use a valid account <strong>email</strong> and  <strong>password</strong> to
            continue.
          </div>
        </div>
      )}
      ...
      <div className='d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8'>
        ...
        {/* begin::Link */}
        <Link to='/auth/forgot-password/staff' className='link-primary'>
          Forgot Password ?
        </Link>
        {/* end::Link */}
      </div>
      ...
      <div className='text-gray-500 text-center fw-semibold fs-6'>
        Swtich Logins?{' '}
        <Link to='/auth/userlogin' className='link-primary'>
          Student Login
        </Link>
      </div>
    </form>
