                ...
                >
                  ...
                  >
                    ...
                    <span
                      ...
                      data-bs-target="#staticBackdrop"
                    >
                      <div style={{ width: "63px", height: "9px" }}>
                        <span
                          style={{
                            fontSize: "12px",
                            fontWeight: "500",
              ...
              >
                {mails.map((group, index) => (
                  ...
                  >
                    ...
                    <td style={{ maxWidth: "355px", minWidth: "160px" }}>
                      <div
                        style={{
                          display: "flex",
                          flexDirection: "column",
                    ...
                    <td
                      style={{ maxWidth: "355px", minWidth: "160px", justifyContent:'left',alignItems:'start' }}
                    >
                      <div
                    ...
                    <td
                      style={{ maxWidth: "355px", minWidth: "80px" }}
                    >
                      <div
                        className="overflow-hidden whitespace-nowrap"
                        style={{
                    ...
                    <td style={{ maxWidth: "115px", minWidth: "10px" }}>
                      <div
                        style={{
                          width: "135px",
                          height: "40px",
